This repository includes python code to reproduce results in the paper ["Some theoretical improvements on the tightness of PAC-Bayes risk certificates for neural networks"](https://arxiv.org/abs/2510.07935). Credit for [most of the code](https://github.com/mperezortiz/PBB) goes to Pérez-Ortiz et al., as it was shared in their [referenced paper](https://www.jmlr.org/papers/volume22/20-879/20-879.pdf).
